  ...
  app.post(
    ...
    async (req, res) => {
      ...
      try {
        ...
        const addServiceBureau = serviceReqResLog.addNew(dldata);
        if (!addServiceBureau)
          throw {
        ...
        axios
          ...
          .then(async (requestResp) => {
            ...
            const serviceBureau = await serviceReqResLog.addNew(dldata);
            if (!serviceBureau)
              throw {
