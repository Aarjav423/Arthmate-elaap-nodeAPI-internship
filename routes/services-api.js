...
module.exports = (app, connection) => {
  ...
  app.post(
    '/api/service',
    [
      check('service_name').notEmpty().withMessage('Service name is required'),
      check('vendor_name').notEmpty().withMessage('Vendor name is required'),
      check('section').notEmpty().withMessage('Section is required'),
      check('url').notEmpty().withMessage('Service url is required'),
      check('type').notEmpty().withMessage('Service type is required'),
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        const { serviceResp, count } = await ServiceLog.getRecords(data);
