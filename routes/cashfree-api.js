...
var Company = require('../models/company-schema.js');
  ...
  app.post(
    ...
    async (req, res, next) => {
      try {
        ...
        // const s3url =
        //   "https://elaap-s3.s3.ap-south-1.amazonaws.com/services/CASHFREE-SUBSCRIPTION-PLANS.txt";
        const s3url =
          req.service && req.service.file_s3_path
        ...
        var subscriptionPlanData = {
          ...
          loan_id: req.body.loan_id ? req.body.loan_id : null,
          borrower_id: req.body.borrower_id ? req.body.borrower_id : null,
          ...
          request_type: '',
          timestamp: Date.now(),
          pan_card: req.body.pan ? req.body.pan : null,
        ...
        axios
          .post(url, JSON.stringify(subscriptionPlanApiData), config)
          .then(async (response) => {
            ...
            const subscriptionPlanDataResp =
              await bureauService.addNew(subscriptionPlanData);
    ...
    async (req, res, next) => {
      try {
        ...
        const s3url =
          req.service && req.service.file_s3_path
            ? req.service.file_s3_path
            : 'https://elaap-s3.s3.ap-south-1.amazonaws.com/services/CASHFREE-SUBSCRIPTIONS.txt';
        // fetch customized template from s3url
        const jsonS3Response = await s3helper.fetchJsonFromS3(
          s3url.substring(s3url.indexOf('services')),
        );
        ...
        //call subscription plan api after successfully uploading request data to s3
        axios
          .post(url, JSON.stringify(subscriptionApiData), config)
          .then(async (response) => {
            //response data from subscription plan to upload on s3
            filename = Math.floor(10000 + Math.random() * 99999) + '_res';
            ...
            //insert response data s3 upload response to database
            const subscriptionDataResp =
              await bureauService.addNew(subscriptionData);
      ...
      try {
        ...
        axios
          ...
          .then(async (response) => {
            ...
            //insert response data s3 upload response to database
            const getSubscriptionDataResp =
              await bureauService.addNew(getSubscriptionData);
  ...
  app.get(
    ...
    async (req, res, next) => {
      try {
        ...
        //Cachfree get subscription payments
        const url =
          process.env.CASHFREE_URL +
          '/api/v2/subscriptions/' +
          req.params.subReferenceId +
    ...
    async (req, res, next) => {
      try {
        ...
        const s3url =
          req.service && req.service.file_s3_path
            ? req.service.file_s3_path
            : 'https://elaap-s3.s3.ap-south-1.amazonaws.com/services/CASHFREE-SUBSCRIPTIONS-CANCEL.txt';
        // fetch customized template from s3url
        const jsonS3Response = await s3helper.fetchJsonFromS3(
          s3url.substring(s3url.indexOf('services')),
        );
    ...
    async (req, res, next) => {
      try {
        ...
        const s3url =
          req.service && req.service.file_s3_path
            ? req.service.file_s3_path
            : 'https://elaap-s3.s3.ap-south-1.amazonaws.com/services/CASHFREE-SUBSCRIPTIONS-CHARGE.txt';
        // fetch customized template from s3url
        const jsonS3Response = await s3helper.fetchJsonFromS3(
          s3url.substring(s3url.indexOf('services')),
        );
    ...
    async (req, res, next) => {
      try {
        ...
        const s3url =
          req.service && req.service.file_s3_path
            ? req.service.file_s3_path
            : 'https://elaap-s3.s3.ap-south-1.amazonaws.com/services/CASHFREE-SUBSCRIPTIONS-CHARGE-RETRY.txt';
        // fetch customized template from s3url
        const jsonS3Response = await s3helper.fetchJsonFromS3(
          s3url.substring(s3url.indexOf('services')),
        );
        ...
        axios
          ...
          .then(async (response) => {
            ...
            //insert response data s3 upload response to database
            const retryPaymentDataResp =
              await bureauService.addNew(retryPaymentData);
    ...
    async (req, res, next) => {
      try {
        ...
        const s3url =
          req.service && req.service.file_s3_path
            ? req.service.file_s3_path
            : 'https://elaap-s3.s3.ap-south-1.amazonaws.com/services/CASHFREE-SUBSCRIPTION-ACTIVATE.txt';
        // fetch customized template from s3url
        const jsonS3Response = await s3helper.fetchJsonFromS3(
          s3url.substring(s3url.indexOf('services')),
        );
      ...
      try {
        ...
        axios
          ...
          .then(async (response) => {
            ...
            //insert response data s3 upload response to database
            const cancelChargeDataResp =
              await bureauService.addNew(cancelChargeData);
