...
const upfrontDailyInterest = function (loanrequest, borrowerinfo) {
  var { loan_app_date, emi_day, sanction_amount, interest_rate } = borrowerinfo;
...
const pincodeToState = function (pincode) {
  return new Promise(function (resolve, reject) {
    ...
    axios
      .post(
        'https://geo-utils-microservice.onrender.com/api/pincode/state',
...
const pincodeToCity = function (pincode) {
  return new Promise(function (resolve, reject) {
    ...
    axios
      .post(
        'https://geo-utils-microservice.onrender.com/api/pincode/city',
        JSON.stringify(input),
        postConfig,
      )
      .then(function (resp) {
...
const monthlyEmi = function (principal, months, interest) {
  return new Promise(function (resolve, reject) {
    ...
    axios
      .post(
        'https://lmsutils-api.onrender.com/api/emi/monthlyemi',
        input,
        postConfig,
      )
      .then(function (resp) {
...
const calculateDisbursal = (loanrequest, borrowerinfo) => {
  return new Promise(function (resolve, reject) {
    ...
    axios
      .post(
        'https://lmsutils-api.onrender.com/api/calculatedisbursal',
        input,
        postConfig,
      )
      .then(function (resp) {
        console.log(
          'calculateDisbursal input \n',
          JSON.stringify(input, null, 2),
          ' gave:\n',
          JSON.stringify(resp.data, null, 2),
        );
...
const calculateDues = function (body) {
  return new Promise(function (resolve, reject) {
    axios
      .post('https://lmsutils-api.onrender.com/api/emi/dues', body, postConfig)
      .then(function (resp) {
