...
module.exports.findByBureauRequestId = async (bureau_request_id) => {
  return await BureauScorecard.findOne({
...
module.exports.updateBureauResponse = async (
  gen_request_id,
  bureau_response,
) => {
  return await BureauScorecard.findOneAndUpdate(
...
module.exports.updateMappedResponse = async (
  gen_request_id,
  mapped_response,
  status,
) => {
...
module.exports.updateById = (id, data) => {
  return BureauScorecard.findOneAndUpdate(
    {
      gen_request_id: id,
    },
    data,
