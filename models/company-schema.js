...
module.exports.getCompanyCount = async () => {
...
module.exports.findCompanyIdArray = (ids) => {
  return Company.find({
    _id: {
      $in: ids,
    },
...
module.exports.getPaginated = async (page, limit, str) => {
  try {
    const query =
      str === null || str === 'null'
        ? {}
...
module.exports.getPaginatedCount = async (page, limit, str) => {
  try {
    const query =
      str === null || str === 'null'
        ? {}
    ...
    return await Company.find(query).count();
  } catch (error) {}
};

module.exports.findByCompanyId = company_id => {
  return Company.findById(company_id, 'name')
}